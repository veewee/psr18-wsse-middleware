...
| `wsaw:UsingAddressing`, `wsam:Addressing`, `wsap:UsingAddressing` | WS-Addressing, not security. `WsaMiddleware` beside this one, and the addressing headers become candidates for `sp:Header` parts. |
