...
| `sp13:ContentSignatureTransform` inside `sp:Attachments` | The content coverage, which is the argument's default: `AttachmentParts::request($storage, ExternalPartCoverage::Content)`. This is what AS4 and eDelivery peers set |
